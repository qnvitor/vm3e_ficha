...
function mostrarEscolhas01() {
var escolhasDiv = document.getElementById("escolhas01");
if (escolhasDiv.style.display === "none") {
    escolhasDiv.style.display = "block";
} else {
    escolhasDiv.style.display = "none";
...
function obterSelecao01() {
var opcoes = document.getElementsByName("opcao01");
var resultadoDiv = document.getElementById("resultado01");
resultadoDiv.innerHTML = "Opção selecionada: ";
...
function mostrarEscolhas02() {
var escolhasDiv = document.getElementById("escolhas02");
if (escolhasDiv.style.display === "none") {
    escolhasDiv.style.display = "block";
} else {
    escolhasDiv.style.display = "none";
...
function obterSelecao02() {
var opcoes = document.getElementsByName("opcao02");
var resultadoDiv = document.getElementById("resultado02");
resultadoDiv.innerHTML = "Opção selecionada: ";
